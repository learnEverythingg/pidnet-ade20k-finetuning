...
class ADE20K(BaseDataset):
    ...
    def read_files(self, img_dir:str, label_dir:str) -> list:
        ...
        print(int(len(img_files))," images")
    ...
    def __getitem__(self, index):
        ...
        resize_img = transforms.Resize(self.resize_size, interpolation=InterpolationMode.BILINEAR)
        resize_label = transforms.Resize(self.resize_size, interpolation=InterpolationMode.NEAREST)
        ...
        new_label = np.ones_like(label) * 255
